<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"100px 0 0 200px","margin":"0","position":"relative","background":"#eaf1ec","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"0 0px 0px rgba(0, 0, 0, .3)","padding":"0 20px 0","borderColor":"#f60","alignItems":"center","color":"#fff","display":"flex","justifyContent":"flex-end","top":"0","left":"0","background":"linear-gradient(90deg, rgba(74,103,82,1) 0%, rgba(94,168,164,1) 100%),#6a8b73","borderWidth":"0 0 4px","width":"calc(100% - 0px)","fontSize":"16px","position":"fixed","borderStyle":"solid","zIndex":"1001","height":"80px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"12px 20px","margin":"0px auto","borderColor":"#3b6885","borderRadius":"8px","borderWidth":"0 0 0px 0","background":"#538577","width":"calc(100% - 80px)","fontSize":"16px","borderStyle":"solid"}' class="bread-crumbs"></bread-crumbs>
