...
// 					// }
	...
	.scrollbar-wrapper-open .el-menu-vertical-2>.el-menu-item.other>.el-tooltip:hover {
		border: 1px solid #feb043 !important;
		outline: 4px solid #292b1e !important;
		color: #feb043 !important;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other /deep/ .el-submenu__title {
		...
		border: 1px solid #4a6752 !important;
		border-radius: 8px !important;
		padding: 0 10px 0 15px !important;
		color: #fff !important;
		white-space: nowrap !important;
		background: #4a6752 !important;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 /deep/ .el-submenu.other .el-menu {
		...
		padding: 15px 0;
		margin: 10px 0 5px;
		background: url(http://codegen.caihongy.cn/20240903/66d5fe8c29204de4bc64b8ee9f82108e.png) no-repeat center top / 100% auto,url(http://codegen.caihongy.cn/20240903/b3859f8f10c547c7b2f7d25e0ea65299.png) no-repeat center bottom / 100% auto,url(http://codegen.caihongy.cn/20240903/83b6455898a64b88b0b252d3b7f39631.png) repeat-y center center / 100% auto;
		width: 100%;
		border-color: #88d8fb;
		border-width: 0px;
		border-style: solid;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other .el-menu .el-menu-item {
		...
		color: #fff !important;
		background: url(http://codegen.caihongy.cn/20240903/8cd615afa8454dbba685461d7ddeba20.png) no-repeat 15px center !important;
		font-size: inherit !important;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other .el-menu .el-menu-item:hover {
		...
		background: url(http://codegen.caihongy.cn/20240903/2306c9ce23464ee5a17f03d604f91d71.png) no-repeat 15px center !important;
		line-height: 30px !important;
		height: 30px !important;
	}
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.home .el-menu .el-menu-item {
		...
		color: #fff;
		background: url(http://codegen.caihongy.cn/20240903/8cd615afa8454dbba685461d7ddeba20.png) no-repeat 15px center;
		font-size: inherit;
		line-height: 30px;
		transition: all 0s;
		height: 30px;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.home .el-menu .el-menu-item:hover {
		padding: 0 20px 0 40px;
		color: #ffba59;
		background: url(http://codegen.caihongy.cn/20240903/2306c9ce23464ee5a17f03d604f91d71.png) no-repeat 15px center;
		line-height: 30px;
		height: 30px;
	}
