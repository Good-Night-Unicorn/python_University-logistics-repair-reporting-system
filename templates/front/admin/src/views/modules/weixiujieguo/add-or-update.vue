	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="维修地点" prop="baoxiudidian" >
					<el-input v-model="ruleForm.baoxiudidian" placeholder="维修地点" clearable  :readonly="ro.baoxiudidian"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="维修地点" prop="baoxiudidian" >
					<el-input v-model="ruleForm.baoxiudidian" placeholder="维修地点" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="维修时长" prop="weixiushizhang" >
					<el-input v-model.number="ruleForm.weixiushizhang" placeholder="维修时长" clearable  :readonly="ro.weixiushizhang"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="维修时长" prop="weixiushizhang" >
					<el-input v-model="ruleForm.weixiushizhang" placeholder="维修时长" readonly></el-input>
				</el-form-item>
			...
			<el-form-item v-if="type!='info'"  label="维修结果" prop="weixiujieguo" >
				<editor 
			...
			<el-form-item v-else-if="ruleForm.weixiujieguo" label="维修结果" prop="weixiujieguo" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.weixiujieguo"></span>
			</el-form-item>
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='weixiushizhang'){
							this.ruleForm.weixiushizhang = obj[o];
							this.ro.weixiushizhang = true;
							continue;
						}
						if(o=='weixiuzhanghao'){
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.weixiujieguo = this.ruleForm.weixiujieguo.replace(reg,'../../../django79tvn57g/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
