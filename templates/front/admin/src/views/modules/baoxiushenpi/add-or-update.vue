		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="报修类型" prop="baoxiuleixing" >
					<el-input v-model="ruleForm.baoxiuleixing" placeholder="报修类型" clearable  :readonly="ro.baoxiuleixing"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="报修类型" prop="baoxiuleixing" >
					<el-input v-model="ruleForm.baoxiuleixing" placeholder="报修类型" readonly></el-input>
				</el-form-item>
				...
				<el-form-item v-else class="input" label="申请时间" prop="shenqingshijian" >
				...
				<el-form-item class="select" v-if="type!='info'"  label="接收状态" prop="jieshouzhuangtai" >
					<el-select :disabled="ro.jieshouzhuangtai" v-model="ruleForm.jieshouzhuangtai" placeholder="请选择接收状态" >
						<el-option
				...
				<el-form-item v-else class="input" label="接收状态" prop="jieshouzhuangtai" >
					<el-input v-model="ruleForm.jieshouzhuangtai"
						placeholder="接收状态" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-else-if="ruleForm.shenheshijian" label="审核时间" prop="shenheshijian" >
				...
				<el-form-item v-else class="input" label="审核结果" prop="shenhejieguo" >
					<el-input v-model="ruleForm.shenhejieguo"
						placeholder="审核结果" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="审批账号" prop="shenpizhanghao" >
					<el-input v-model="ruleForm.shenpizhanghao" placeholder="审批账号" clearable  :readonly="ro.shenpizhanghao"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="审批账号" prop="shenpizhanghao" >
					<el-input v-model="ruleForm.shenpizhanghao" placeholder="审批账号" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="审批姓名" prop="shenpixingming" >
					<el-input v-model="ruleForm.shenpixingming" placeholder="审批姓名" clearable  :readonly="ro.shenpixingming"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="审批姓名" prop="shenpixingming" >
					<el-input v-model="ruleForm.shenpixingming" placeholder="审批姓名" readonly></el-input>
				</el-form-item>
			</template>
			...
			<el-form-item v-else-if="ruleForm.shenheyijian" label="审核意见" prop="shenheyijian" >
				<span class="text">{{ruleForm.shenheyijian}}</span>
			</el-form-item>
		...
		methods: {
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					this.ruleForm.jieshouzhuangtai = '未接收'; 				}
				// 获取用户信息
				this.$http({
					...
					if (data && data.code === 0) {
						...
						if(((json.shenpizhanghao!=''&&json.shenpizhanghao) || json.shenpizhanghao==0) && this.$storage.get("role")!="管理员"){
							this.ruleForm.shenpizhanghao = json.shenpizhanghao
							this.ro.shenpizhanghao = true;
						}
						if(((json.shenpixingming!=''&&json.shenpixingming) || json.shenpixingming==0) && this.$storage.get("role")!="管理员"){
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `baoxiushenpi/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.baoxiushenpiCrossAddOrUpdateFlag = false;
											this.parent.search();
