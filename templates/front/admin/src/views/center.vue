<template>
	<div :style='{"padding":"20px 30px","textAlign":"center","fontSize":"15px"}'>
		<el-form
			:style='{"padding":"40px 0","borderColor":"#eee","borderStyle":"solid","borderWidth":"0px 0 0","background":"#fff"}'
		...
		>
				...
				<el-form-item :style='{"border":"0px solid #eee","width":"49%","padding":"0","margin":"0 0 26px 0","textAlign":"left","display":"inline-block"}'   v-if="flag=='weixiurenyuan'"  label="联系方式" prop="lianxifangshi">
				...
				<el-form-item :style='{"border":"0px solid #eee","width":"49%","padding":"0","margin":"0 0 26px 0","textAlign":"left","display":"inline-block"}'   v-if="flag=='shenpiyuan'"  label="审批账号" prop="shenpizhanghao">
					<el-input v-model="ruleForm.shenpizhanghao" readonly						placeholder="审批账号" clearable></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","width":"49%","padding":"0","margin":"0 0 26px 0","textAlign":"left","display":"inline-block"}'   v-if="flag=='shenpiyuan'"  label="审批姓名" prop="shenpixingming">
					<el-input v-model="ruleForm.shenpixingming" 						placeholder="审批姓名" clearable></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","width":"49%","padding":"0","margin":"0 0 26px 0","textAlign":"left","display":"inline-block"}' v-if="flag=='shenpiyuan'"  label="性别" prop="xingbie">
					<el-select v-model="ruleForm.xingbie"  placeholder="请选择性别">
						<el-option
				...
				<el-form-item :style='{"border":"0px solid #eee","width":"49%","padding":"0","margin":"0 0 26px 0","textAlign":"left","display":"inline-block"}'   v-if="flag=='shenpiyuan'"  label="联系手机" prop="lianxishouji">
					<el-input v-model="ruleForm.lianxishouji" 						placeholder="联系手机" clearable></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","width":"49%","padding":"0","margin":"0 0 26px 0","textAlign":"left","display":"inline-block"}' v-if="flag=='shenpiyuan'" label="头像" prop="touxiang">
					<file-upload
						tip="点击上传头像"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"padding":"0","margin":"20px 0 0"}'>
					<el-button class="btn3" :style='{"border":"0px solid #ccc","cursor":"pointer","padding":"0 10px","margin":"0 10px 0 0","color":"#fff","borderRadius":"4px","background":"#4a6752","width":"auto","fontSize":"16px","minWidth":"110px","height":"40px"}' type="primary" @click="onUpdateHandler">
...
export default {
	...
	methods: {
		...
		onUpdateHandler() {
			...
			if((!this.ruleForm.shenpizhanghao)&& 'shenpiyuan'==this.flag){
				this.$message.error('审批账号不能为空');
				return
			}
			...
			if((!this.ruleForm.shenpixingming)&& 'shenpiyuan'==this.flag){
				this.$message.error('审批姓名不能为空');
				return
			}
			...
			if((!this.ruleForm.lianxishouji)&& 'shenpiyuan'==this.flag){
				this.$message.error('联系手机不能为空');
				return
			}


			if( 'shenpiyuan' ==this.flag && this.ruleForm.lianxishouji&&(!isMobile(this.ruleForm.lianxishouji))){
